...
<p style="background-color: yellow">This is the last supported version of standalone FPW Post Thumbnails plugin. Now this plugin is embedded into FPW Category Thumbnails plugin.</p>
